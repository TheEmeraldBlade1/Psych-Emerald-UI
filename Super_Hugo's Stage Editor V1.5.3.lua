...
overwriteFile = false		--if a file with same name exists, does it overwrite it?

stopRunningScripts = false		--stops any scripts from running so there aren't any conflicts (RECOMMENDED)
